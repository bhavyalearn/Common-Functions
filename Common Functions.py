...
def loadData(path, file,sheetName=0,sep=","):
    """
    ...
    sheetName - sheetname from which data is to be read. Default is '0'; i.e. first sheet is read. 
                Not required for CSV file types
